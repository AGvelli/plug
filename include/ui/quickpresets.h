...
namespace plug
{
    ...
    private slots:
        ...
        void setDefaultPreset10(int);
        void setDefaultPreset11(int);
        void setDefaultPreset12(int);
        void setDefaultPreset13(int);
        void setDefaultPreset14(int);
        void setDefaultPreset15(int);
        void setDefaultPreset16(int);
        void setDefaultPreset17(int);
        void setDefaultPreset18(int);
        void setDefaultPreset19(int);
        void setDefaultPreset20(int);
        void setDefaultPreset21(int);
        void setDefaultPreset22(int);
        void setDefaultPreset23(int);
